function isWidgetPath(filePath: string) {
  return (
    filePath.indexOf('/node_modules/') === -1 &&
    filePath.indexOf('/src/') === -1 &&
    filePath.indexOf('/lib/') === -1 &&
    filePath.indexOf('/inactive/') === -1 &&
    /\.coffee$|\.js$|\.jsx$/.test(filePath)
  );
}

function widgetId(filePath: string, rootPath: string) {
...
export default function resolveWidget(fileEvent: any) {
